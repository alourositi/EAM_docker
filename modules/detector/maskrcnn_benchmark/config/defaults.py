...
# path
#_C.MODEL.WEIGHT = "MSRA/R-50"
_C.MODEL.WEIGHT = "MSRA/R-101"
...
_C.DATASETS.TRAIN = ['mydataset_train']
# List of the dataset names for testing, as present in paths_catalog.py
_C.DATASETS.TEST = ['mydataset_test']
...
#_C.MODEL.ROI_BOX_HEAD.NUM_CLASSES = 84
...
#NOTE NUMBER OF CLASSES IN THE FINAL LAYER (PREDICTOR)
#_C.MODEL.ROI_KEYPOINT_HEAD.NUM_CLASSES = 17
_C.MODEL.ROI_KEYPOINT_HEAD.NUM_CLASSES = 83
...
_C.MODEL.RETINANET.NUM_CLASSES = 84
