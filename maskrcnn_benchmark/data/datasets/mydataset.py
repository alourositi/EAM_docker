...
#class MyDataset():
    def __init__(self, transforms=None):
        ...
        #test_data = pd.read_csv('thermal_test_dataset.csv')
        ...
        self.paths = train_data['Path'].tolist()
        self.photos = train_data['JPG'].tolist()
        ...
        self.img_width = train_data['Width'].tolist()
        self.img_height = train_data['Height'].tolist()
        self.objects = train_data['Num of Objects'].tolist()

        lbls = train_data['Labels'].tolist()
        labs = []
        for lbl in lbls:
            labs = []
            for l in lbl:
        ...
        self.bboxes = train_data['Boxes'].tolist()
        self.id_to_img_map = list(range(train_data.size))
